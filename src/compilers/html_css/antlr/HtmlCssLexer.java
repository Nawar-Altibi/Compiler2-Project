// Generated from C:/Users/abdsa/IdeaProjects/Compiler_project/src/Rules/HtmlCssLexer.g4 by ANTLR 4.13.2
...
public class HtmlCssLexer extends Lexer {
	...
	public static final int
		TAG=1, ATTVALUE=2, STYLE=3, JINJA_EXPRESSION=4, JINJA_STATEMENT=5;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "TAG", "ATTVALUE", "STYLE", "JINJA_EXPRESSION", "JINJA_STATEMENT"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"JINJA_EXPRESSION_START", "JINJA_STATEMENT_START", "JINJA_COMMENT", "HTML_COMMENT", 
			...
			"SINGLE_QUOTE_STRING", "STYLE_BODY", "STYLE_SHORT_BODY", "JINJA_EXPRESSION_END", 
